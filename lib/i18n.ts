...
export function faqsByCategory(): { category: FaqCategory; items: Faq[] }[] {
  const cats: FaqCategory[] = ['生活', '手続き', '仕事', 'その他'];
...
export const T: Record<'ja' | 'en' | 'vi' | 'id' | 'ne' | 'my', Dict> = {
  ja: {
    ...
    life: '生活', proce: '手続き', work: '仕事', other: 'その他', switched: '地域を切り替えました', staffMsg: 'スタッフにおつなぎします。確認して、できるだけ早くお返事します。（プロトタイプ）', errNet: '接続に失敗しました。',
  ...
  en: {
    ...
    life: 'Daily life', proce: 'Procedures', work: 'Work', other: 'Other', switched: 'Area switched', staffMsg: 'Connecting you to staff. We will check and reply as soon as possible. (Prototype)', errNet: 'Connection failed.',
  ...
  vi: {
    ...
    life: 'Đời sống', proce: 'Thủ tục', work: 'Công việc', other: 'Khác', switched: 'Đã chuyển khu vực', staffMsg: 'Đang kết nối với nhân viên. Chúng tôi sẽ kiểm tra và trả lời sớm nhất có thể. (Bản thử nghiệm)', errNet: 'Kết nối thất bại.',
  ...
  id: {
    ...
    life: 'Kehidupan', proce: 'Prosedur', work: 'Pekerjaan', other: 'Lainnya', switched: 'Wilayah diganti', staffMsg: 'Menghubungkan Anda ke staf. Kami akan memeriksa dan membalas secepatnya. (Prototipe)', errNet: 'Koneksi gagal.',
  ...
  ne: {
    ...
    life: 'जीवन', proce: 'प्रक्रिया', work: 'काम', other: 'अन्य', switched: 'क्षेत्र परिवर्तन भयो', staffMsg: 'कर्मचारीसँग जोड्दैछौं। जाँचेर सकेसम्म चाँडो जवाफ दिनेछौं। (प्रोटोटाइप)', errNet: 'जडान असफल भयो।',
  ...
  my: {
    ...
    life: 'နေ့စဉ်ဘဝ', proce: 'လုပ်ထုံးလုပ်နည်း', work: 'အလုပ်', other: 'အခြား', switched: 'ဒေသ ပြောင်းပြီး', staffMsg: 'ဝန်ထမ်းနှင့် ချိတ်ဆက်ပေးနေပါသည်။ စစ်ဆေးပြီး အမြန်ဆုံး ပြန်ဖြေပါမည်။ (ပုံစံငယ်)', errNet: 'ချိတ်ဆက်မှု မအောင်မြင်ပါ။',
